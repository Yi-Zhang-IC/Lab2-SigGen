...
void Vtop::_initial__TOP__2(Vtop__Syms* __restrict vlSymsp) {
    ...
    VL_READMEM_N(true, 8, 256, 0, VL_CVT_PACK_STR_NW(3, __Vtemp1)
                 , vlTOPp->top__DOT__rom2ports__DOT__rom_array
                 , 0, ~0ULL);
}
...
void Vtop::_ctor_var_reset() {
    ...
    top__DOT__address = VL_RAND_RESET_I(8);
    top__DOT__wire1 = VL_RAND_RESET_I(8);
    { int __Vi0=0; for (; __Vi0<256; ++__Vi0) {
            top__DOT__rom2ports__DOT__rom_array[__Vi0] = VL_RAND_RESET_I(8);
    }}
